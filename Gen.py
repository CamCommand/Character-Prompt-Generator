...
path = input("Enter the path that the code is located in, example- C:\\Users\\Name\\Downloads\\CharacterGen : ")
...
# I use 3 different for loops to easily see which list is beinging looped through and also the lists are different sizes
